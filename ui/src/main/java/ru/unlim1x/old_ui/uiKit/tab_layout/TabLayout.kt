package ru.unlim1x.old_ui.uiKit.tab_layout
...
import ru.unlim1x.old_ui.uiKit.cards.MeetingCard
import ru.unlim1x.old_ui.uiKit.cards.loading_cards.LoadingMeetingCardExperimental
import ru.unlim1x.old_ui.uiKit.tab_layout.model.TabData
import java.security.InvalidParameterException

@Deprecated(
    "Deprecated since new design introduced. Don't use this layout",
...
@Composable
internal fun PageMeetingsAll(navController: NavController, listMeetings: List<Meeting>) {
...
@Composable
internal fun PageMeetingsActive(navController: NavController, listMeetings: List<Meeting>) {
    LazyColumn(
        modifier = Modifier
            .fillMaxHeight()
            .background(color = DevMeetTheme.colorScheme.neutralWhite)
...
@Composable
internal fun PageMeetingsPlanned(navController: NavController, listMeetings: List<Meeting>) {
    LazyColumn(
        modifier = Modifier
            .fillMaxHeight()
            .background(color = DevMeetTheme.colorScheme.neutralWhite)
...
@Composable
internal fun PageMeetingsPassed(navController: NavController, listMeetings: List<Meeting>) {
    LazyColumn(
        modifier = Modifier
            .fillMaxHeight()
            .background(color = DevMeetTheme.colorScheme.neutralWhite)
...
@Composable
internal fun PageMeetingsLoading() {
