...
sealed class CommunityDetailedScreenViewState {
    ...
    data class Display(val community: Flow<CommunityDetailed>, val listOfMeetings:Flow<List<Meeting>>, val initial:CommunityDetailed):CommunityDetailedScreenViewState()
